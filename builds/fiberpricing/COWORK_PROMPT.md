# AppsForHire — Build: Fiber Pricing
**Client:** Black Sheep Fiber Frarm
**Slug:** `fiberpricing`
**Live URL:** https://fiberpricing.appsforhire.app
**Tier:** Starter
...
```
/app_for_hire/builds/fiberpricing/index.html
```
...
Fiber type: wool, mohair, dyed, roving, calculated by price per ounce based off price per pound. Also custom orders calculated with additional price per ounce of $4.

---

## Brand & Design System

- **Business name:** Black Sheep Fiber Frarm
- **App title:** Fiber Pricing
- **Subtitle / description:** Calculator for price per ounce
- **Brand accent color:** `#4f46e5` (Indigo) — use as `--accent`
- **Brand accent dark:** `#3730a3` — use as `--accent-dark`
